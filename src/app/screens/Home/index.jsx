...
function HomePage(props) {
  ...
  function renderNewTodoDialog() {
    ...
    return (
      <Dialog open={showNewTodoDialog} aria-labelledby="form-dialog-title">
        ...
        <DialogContent>
          <DialogContentText>
            Enter the required information to add a Todo Item and click SAVE.
          </DialogContentText>
          <TextField
            autoFocus
            defaultValue={title}
  ...
  function renderLists() {
    if (todoLists.length > 0) {
      ...
      return (
        <div>
          <span className={classes.emptyListText}>There is no Todo List registered.</span>
        </div>
      )
    }
  }
        ...
        <div className={classes.drawerContainer}>
          <List>
            <ListItem button onClick={() => setTodoListsOpen(!todoListsOpen)}>
              ...
              <ListItemText primary="Todo By Letter"/>
