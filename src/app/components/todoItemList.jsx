  ...
  if (props.list.id) {
    return (
      <Container maxWidth="lg" className={classes.container}>
        ...
        {props.list.todoList.length === 0 &&
        <div>
          <h5 style={{textAlign: 'center', padding: 25}}>There is no Todo Item in your list.
    ...
    return (
      <div>
        <h3 style={{textAlign: 'center', padding: 25}}>No saved Todo List found, please add first Todo from left menu
          Add your list.</h3>
      </div>
    )
  }
